        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#fffbef] border border-[rgba(63,64,63,0.08)] rounded-2xl p-8 text-center">
            ...
            <p className="text-[#575b44] font-norwester">
              Timers that fit your style. Choose from 6 proven study methods designed to maximize your concentration.
            </p>
          </div>
          ...
          <div className="bg-[#fffbef] border border-[rgba(63,64,63,0.08)] rounded-2xl p-8 text-center">
            ...
            <p className="text-[#575b44] font-norwester">
              Lightweight and private. Study anywhere with our responsive web app that works offline.
            </p>
          </div>
        </div>
      </div>
