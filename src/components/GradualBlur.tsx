...
const getGradientDirection = (position: string) => {
  ...
  return directions[position as keyof typeof directions] || 'to bottom';
};
...
const useIntersectionObserver = (ref: React.RefObject<HTMLElement | null>, shouldObserve: boolean = false) => {
      ...
      const divStyle: React.CSSProperties = {
        ...
        transition:
          config.animated && config.animated !== 'scroll'
            ...
            : undefined,
        // Add a subtle background to enhance the fade effect
        background: `linear-gradient(${direction}, transparent 0%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.2) 100%)`
      };
