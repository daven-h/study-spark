...
class OptimizedAttentionTracker:
    """
    Optimized attention tracker with YOLO + MediaPipe + Enhanced Focus Logic
    """
    ...
    def __init__(self, camera_index: int = 0, frame_width: int = 640, 
        ...
        print(f"✅ Optimized Attention Tracker initialized: {self.frame_width}x{self.frame_height}")
    ...
    def draw_enhanced_status_overlay(self, frame, metrics):
        ...
        # Title
        cv2.putText(frame, "OPTIMIZED ATTENTION TRACKER", (panel_x + 15, panel_y + 30),
    ...
    def draw_phone_boxes(self, frame, yolo_objects):
    ...
    def run(self):
        ...
        print("🚀 Starting Optimized Attention Tracker...")
        print("📱 YOLO + MediaPipe + Enhanced Focus Logic")
        ...
        while True:
            ...
            frame = self.draw_phone_boxes(frame, metrics.get("yolo_objects", []))
            ...
            # Display frame
            cv2.imshow('Optimized Attention Tracker', frame)
        ...
        print("✅ Optimized Attention Tracker stopped")

def main():
    tracker = OptimizedAttentionTracker(
        camera_index=0, 
        frame_width=640, 
        frame_height=480
    )
